                                ...
                                <div class="header-contact-info">
                                    <div class="header-info-single-item">
                                        ...
                                        <div class="header-info-single-item__content">
                                            ...
                                            <p class="header-info-single-item__subtitle">+91 8768 5087 44</p>
                                        </div>
                                    </div>
                                    <div class="header-info-single-item">
                                        <div class="header-info-single-item__icon">
                                        ...
                                        <div class="header-info-single-item__content">
                                            ...
                                            <p class="header-info-single-item__subtitle">Central market, New Delhi, Building Apt. C 25 3rd floor, 110024, India</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="header-navigation__nav position-static">
                                    <nav>
                                        <ul>
                                            ...
                                            @if(Auth::check())
                                            <li><a href="{{route('admin.blog.index')}}">Admin</a> </li>
                                            @endif
                                        </ul>
                                    </nav>
                                </div>
                            ...
                            <div class="col-xl-2 offset-xl-1 col-lg-3 col-md-4">
                                ...
                                <div class="footer-widget mb-0">
                                    ...
                                    <div class="footer-widget__content">
                                        <p class="address">Central market, New Delhi, Building Apt. C 25 3rd floor, 110024, India</p>
                                        <ul class="contact-details">
                                            <li><span>Phone:</span>+91 8768508744</li>
                                            
                                            <li><span>E:</span>support@technosofthunter.com</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
